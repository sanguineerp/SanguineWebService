...
@Controller
public class clsTextFormat23ForBill {

	@Autowired
	clsTextFileGenerator objTextFileGenerator;
	
	 
   public void funGenerateTextFileForBillFormat23(String billNo, String posCode, String clientCode,String reprint,String strServerBillPrinterName)
    {
	...
	try
	{
	    ...
	    {
			pw.print(objTextFileGenerator.funPrintTextWithAlignment("TEL NO.", 8, "Left"));
			pw.print(objTextFileGenerator.funPrintTextWithAlignment(":", 2, "Left"));
			pw.print(objTextFileGenerator.funPrintTextWithAlignment(telephone, 12, "Left"));
			/*pw.println(" ");*/
	    }
	    if (!email.isEmpty())
	    {
			pw.print(objTextFileGenerator.funPrintTextWithAlignment("E-ID", 5, "Left"));
			pw.print(objTextFileGenerator.funPrintTextWithAlignment(":", 2, "Left"));
			pw.print(objTextFileGenerator.funPrintTextWithAlignment(email, 18, "Left"));
			pw.println(" ");
	    }
	    ...
	    pw.println(line);
	    pw.print(objTextFileGenerator.funPrintTextWithAlignment("POS Name", 9, "Left"));
	    pw.print(objTextFileGenerator.funPrintTextWithAlignment(":", 2, "Left"));
	    ...
	    if(paxNo != 0)
	    {
		    ...
		    pw.print(objTextFileGenerator.funPrintTextWithAlignment(":", 2, "Left"));
		    pw.print(objTextFileGenerator.funPrintTextWithAlignment(String.valueOf(paxNo), 38, "Left"));
		    pw.println(" ");
	    }
	    pw.print(objTextFileGenerator.funPrintTextWithAlignment("BILL NO.", 9, "Left"));
	    pw.print(objTextFileGenerator.funPrintTextWithAlignment(":", 2, "Left"));
	    pw.print(objTextFileGenerator.funPrintTextWithAlignment(billno, 10, "Left"));
	    /*pw.println(" ");*/
	    pw.print(objTextFileGenerator.funPrintTextWithAlignment("DATE", 5, "Left"));
	    pw.print(objTextFileGenerator.funPrintTextWithAlignment(":", 2, "Left"));
	    pw.print(objTextFileGenerator.funPrintTextWithAlignment(sdf.format(dteBillDate), 19, "Left"));
