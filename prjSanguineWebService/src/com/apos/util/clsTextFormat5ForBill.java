   ...
   public void funGenerateTextFileForBillFormat5(String billNo, String posCode, String clientCode,String reprint)
	...
	try
	{
	    ...
	    if (dblUSDConverionRate > 0)
	    {
		    ...
		    pw.print(objTextFileGenerator.funPrintTextWithAlignment("$" + gdTotal/ dblUSDConverionRate, 8, "RIGHT"));
		    pw.println(" ");
	    }
	    pw.println(line);
                    ...
                    if (dtlBillSeriesBillNo.length > 0)
                    {
                        for (int i = 0; i < dtlBillSeriesBillNo.length; i++)
                        {
                            ...
                            if (rsPrintGT.next())
                            {
                            	 ...
                            	 pw.print(objTextFileGenerator.funPrintTextWithAlignment("" + rsPrintGT.getDouble(2), 8, "RIGHT"));
                         	     pw.println(" ");
                         	     pw.println(line);
                         ...
                         pw.println(line);
                   	 	 ...
                   	 	 pw.print(objTextFileGenerator.funPrintTextWithAlignment("" + String.valueOf(dblOtherBillsGT), 8, "RIGHT"));
                	     pw.println(" ");
                	     pw.println(line);
