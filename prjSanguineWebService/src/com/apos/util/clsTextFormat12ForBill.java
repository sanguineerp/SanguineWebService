...
@Controller
public class clsTextFormat12ForBill {

	@Autowired
	clsTextFileGenerator objTextFileGenerator;
	
	  
   public void funGenerateTextFileForBillFormat12(String billNo, String posCode, String clientCode,String reprint,String strServerBillPrinterName,String multiBillPrint)
    {
	...
	try
	{
	    ...
	    pw.print(objTextFileGenerator.funPrintTextWithAlignment(" ITEMNAME", 20, "Left"));
	    pw.print(objTextFileGenerator.funPrintTextWithAlignment("AMT", 8, "RIGHT"));
	    pw.print(objTextFileGenerator.funPrintTextWithAlignment("RATE", 6, "RIGHT"));
	    pw.println(" ");
	    pw.println(line);
		...
		pw.print(objTextFileGenerator.funPrintTextWithAlignment("" + items.get(3), 6, "RIGHT"));
		pw.println(" ");
	    }
	    ...
	    if(arrSettleBillDtl.size()>0)
	    {
			...
			pw.print(objTextFileGenerator.funPrintTextWithAlignment("" +gdTotal , 23, "RIGHT"));
			pw.println(" ");
		    pw.println(line);
	    }
